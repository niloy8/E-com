...
const Order = ({ cart, handleClearCart, children }) => {
    ...
    return (
        <div className='order'>
            ...
            <button onClick={handleClearCart} className='clear-cart'><span>Clear Cart</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
