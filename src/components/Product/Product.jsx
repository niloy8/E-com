...
const Product = (props) => {
    ...
    return (
        <div className='product'>
            ...
            <button onClick={() => handleAddtocart(props.product)} className='btn-cart'><span>Add to cart</span>
                <span><svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 24" fill="none">
